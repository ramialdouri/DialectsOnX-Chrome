...
def test_feed_contract() -> None:
    ...
    _assert("height: 32px" in content, "logo height matches Original")
    _assert("align-items: center" in content, "control bar vertical center")
    ...
    _assert("dox-dots i" in theme and "prefers-reduced-motion" in theme, "dots respect reduced motion")
